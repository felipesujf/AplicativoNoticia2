...
public class BancoController {
    ...
    public String insereDado(String titulo, String autor, String noticia){
        ...
        valores.put(CriaBanco.NOTICIA, noticia);
    ...
    public Cursor carregaDadoById(int id){
        Cursor cursor;
        String[] campos =  {banco.ID,banco.TITULO,banco.AUTOR,banco.NOTICIA};
    ...
    public void alteraRegistro(int id, String titulo, String autor, String noticia){
        ContentValues valores;
        String where;
